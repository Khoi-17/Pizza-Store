 ...
 * @author Admin
 */
@WebServlet(name = "CategoryManagementController", urlPatterns = {"/CategoryManagementController"})
public class CategoryManagementController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CategoryDTO> category = categoryDAO.getAllCategories();
